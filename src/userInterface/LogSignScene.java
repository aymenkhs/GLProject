...
public class LogSignScene {
    ...
    public void createLoginScene(){
        ...
        loginScene.getStylesheets().add(UserUI.class.getResource("../style.css").toExternalForm());
    }
    ...
    public void createSignInScene(){
        ...
        Scene signinScene = new Scene(signInGrid, 700, 433);
        signinScene.getStylesheets().add(UserUI.class.getResource("../style.css").toExternalForm());
